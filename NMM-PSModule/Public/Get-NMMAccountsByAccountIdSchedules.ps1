function Get-NMMAccountsByAccountIdSchedules {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdSchedules -Connection $connection
.OUTPUTS
...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/schedules' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
