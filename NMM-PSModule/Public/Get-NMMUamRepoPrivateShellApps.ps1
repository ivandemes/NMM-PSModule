...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/uam/repo/private/shell/apps' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
