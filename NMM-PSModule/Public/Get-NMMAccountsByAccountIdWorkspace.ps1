...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/workspace' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
