function Get-NMMAccountsByAccountIdSecureVariables {
    <#
.SYNOPSIS
...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/secure-variables' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
