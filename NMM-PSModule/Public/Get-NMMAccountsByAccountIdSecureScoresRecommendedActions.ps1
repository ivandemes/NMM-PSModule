function Get-NMMAccountsByAccountIdSecureScoresRecommendedActions {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdSecureScoresRecommendedActions -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/secure-scores/recommended-actions
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/secure-scores/recommended-actions' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
