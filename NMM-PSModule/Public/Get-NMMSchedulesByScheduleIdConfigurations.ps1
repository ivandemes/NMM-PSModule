...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/schedules/{scheduleId}/configurations' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
