...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/autoscale-profiles' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
