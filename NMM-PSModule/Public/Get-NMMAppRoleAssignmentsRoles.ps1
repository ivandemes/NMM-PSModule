...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/app-role-assignments/roles' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
