...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/fslogix' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
