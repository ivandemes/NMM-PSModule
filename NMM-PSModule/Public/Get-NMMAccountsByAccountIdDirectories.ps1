function Get-NMMAccountsByAccountIdDirectories {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdDirectories -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/directories
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/directories' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
