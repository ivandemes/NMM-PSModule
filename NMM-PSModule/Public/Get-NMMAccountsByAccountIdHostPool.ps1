function Get-NMMAccountsByAccountIdHostPool {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdHostPool -Connection $connection
.OUTPUTS
...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/host-pool' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
