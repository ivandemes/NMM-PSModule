function Get-NMMAccountsByAccountIdInheritedVariables {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdInheritedVariables -Connection $connection
.OUTPUTS
...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/inherited-variables' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
