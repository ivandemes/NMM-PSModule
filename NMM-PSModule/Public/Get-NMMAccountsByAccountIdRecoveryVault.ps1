...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/recovery-vault' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
