...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/uam/appslibrary/shellapps' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
