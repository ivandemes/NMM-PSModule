...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/recovery-vault/allvaults' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
