...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/reservations/{reservationId}/resources' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
