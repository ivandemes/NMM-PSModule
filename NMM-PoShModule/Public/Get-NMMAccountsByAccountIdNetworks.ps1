function Get-NMMAccountsByAccountIdNetworks {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdNetworks -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/networks
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/networks' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
