function Get-NMMAccountsByAccountIdLocationVariables {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdLocationVariables -Connection $connection
.OUTPUTS
...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/location-variables' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
