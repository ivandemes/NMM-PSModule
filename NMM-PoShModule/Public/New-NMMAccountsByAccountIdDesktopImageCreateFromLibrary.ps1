function New-NMMAccountsByAccountIdDesktopImageCreateFromLibrary {
    <#
.SYNOPSIS
...
.EXAMPLE
New-NMMAccountsByAccountIdDesktopImageCreateFromLibrary -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/desktop-image/create-from-library
#>
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('/rest-api/v1/accounts/{accountId}/desktop-image/create-from-library', 'POST')) {
            Invoke-NMMApiRequest -Method 'POST' -Path '/rest-api/v1/accounts/{accountId}/desktop-image/create-from-library' -PathValues $pathValues -QueryValues $queryValues -Body $InputObject -BodyWasBound:$PSBoundParameters.ContainsKey('InputObject') -Connection $Connection
        }
    }
}
