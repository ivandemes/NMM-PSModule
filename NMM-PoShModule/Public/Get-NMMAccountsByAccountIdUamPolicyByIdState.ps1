function Get-NMMAccountsByAccountIdUamPolicyByIdState {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdUamPolicyByIdState -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/uam/policy/{id}/state
#>
    ...
    process {
        ...
        Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/uam/policy/{id}/state' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
    }
}
