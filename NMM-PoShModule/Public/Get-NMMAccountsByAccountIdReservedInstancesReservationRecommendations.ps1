function Get-NMMAccountsByAccountIdReservedInstancesReservationRecommendations {
    <#
.SYNOPSIS
...
.EXAMPLE
Get-NMMAccountsByAccountIdReservedInstancesReservationRecommendations -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/reservedInstances/reservationRecommendations
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/reservedInstances/reservationRecommendations' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
