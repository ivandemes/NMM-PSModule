...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/uam/repo/private/shell/apps' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
