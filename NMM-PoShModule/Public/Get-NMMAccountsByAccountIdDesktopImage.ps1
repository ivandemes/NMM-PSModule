...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/desktop-image' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
