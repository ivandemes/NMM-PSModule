function Get-NMMAccountsByAccountIdUamAppGroup {
    <#
.SYNOPSIS
Get app groups.
.DESCRIPTION
...
.EXAMPLE
Get-NMMAccountsByAccountIdUamAppGroup -Connection $connection
.OUTPUTS
...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/uam/appGroup' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
