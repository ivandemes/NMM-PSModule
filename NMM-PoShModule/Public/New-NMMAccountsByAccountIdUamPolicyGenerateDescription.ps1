function New-NMMAccountsByAccountIdUamPolicyGenerateDescription {
    <#
.SYNOPSIS
...
.EXAMPLE
New-NMMAccountsByAccountIdUamPolicyGenerateDescription -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/uam/policy/generateDescription
#>
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('/rest-api/v1/accounts/{accountId}/uam/policy/generateDescription', 'POST')) {
            Invoke-NMMApiRequest -Method 'POST' -Path '/rest-api/v1/accounts/{accountId}/uam/policy/generateDescription' -PathValues $pathValues -QueryValues $queryValues -Body $InputObject -BodyWasBound:$PSBoundParameters.ContainsKey('InputObject') -Connection $Connection
        }
    }
}
