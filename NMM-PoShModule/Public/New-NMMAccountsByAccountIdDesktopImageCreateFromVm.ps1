function New-NMMAccountsByAccountIdDesktopImageCreateFromVm {
    <#
.SYNOPSIS
...
.EXAMPLE
New-NMMAccountsByAccountIdDesktopImageCreateFromVm -Connection $connection
.OUTPUTS
System.Management.Automation.PSObject
.LINK
/rest-api/v1/accounts/{accountId}/desktop-image/create-from-vm
#>
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('/rest-api/v1/accounts/{accountId}/desktop-image/create-from-vm', 'POST')) {
            Invoke-NMMApiRequest -Method 'POST' -Path '/rest-api/v1/accounts/{accountId}/desktop-image/create-from-vm' -PathValues $pathValues -QueryValues $queryValues -Body $InputObject -BodyWasBound:$PSBoundParameters.ContainsKey('InputObject') -Connection $Connection
        }
    }
}
