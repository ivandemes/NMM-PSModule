...
#>
    ...
    process {
        ...
        $response = Invoke-NMMApiRequest -Method 'GET' -Path '/rest-api/v1/accounts/{accountId}/environment-variables' -PathValues $pathValues -QueryValues $queryValues -Connection $Connection
