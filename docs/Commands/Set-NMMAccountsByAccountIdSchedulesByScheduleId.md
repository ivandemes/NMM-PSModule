...
~~~powershell
Set-NMMAccountsByAccountIdSchedulesByScheduleId -ScheduleId <integer> -AccountId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
PUT /rest-api/v1/accounts/{accountId}/schedules/{scheduleId}
