...
~~~powershell
New-NMMUamRepoPrivateWingetByRepoIdAppsImport -RepoId <integer> [-InputObject <object>] [-Connection <psobject>]
~~~
...
POST /rest-api/v1/uam/repo/private/winget/{repoId}/apps/import
