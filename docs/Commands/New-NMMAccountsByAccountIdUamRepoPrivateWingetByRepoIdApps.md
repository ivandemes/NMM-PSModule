...
~~~powershell
New-NMMAccountsByAccountIdUamRepoPrivateWingetByRepoIdApps -RepoId <integer> -AccountId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
POST /rest-api/v1/accounts/{accountId}/uam/repo/private/winget/{repoId}/apps
