...
~~~powershell
New-NMMUamRepoPrivateWingetByRepoIdAppsByPackageIdVersion -RepoId <integer> -PackageId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
POST /rest-api/v1/uam/repo/private/winget/{repoId}/apps/{packageId}/version
