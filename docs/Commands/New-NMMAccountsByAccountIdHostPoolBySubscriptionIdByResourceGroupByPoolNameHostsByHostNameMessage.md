...
~~~powershell
New-NMMAccountsByAccountIdHostPoolBySubscriptionIdByResourceGroupByPoolNameHostsByHostNameMessage -SubscriptionId <string> -ResourceGroup <string> -PoolName <string> -HostName <string> -AccountId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
POST /rest-api/v1/accounts/{accountId}/host-pool/{subscriptionId}/{resourceGroup}/{poolName}/hosts/{hostName}/message
