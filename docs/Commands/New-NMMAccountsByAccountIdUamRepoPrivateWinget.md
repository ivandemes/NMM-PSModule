...
~~~powershell
New-NMMAccountsByAccountIdUamRepoPrivateWinget -AccountId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
POST /rest-api/v1/accounts/{accountId}/uam/repo/private/winget
