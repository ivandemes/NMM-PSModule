...
~~~powershell
New-NMMAccountsByAccountIdUamPolicyGenerateDescription -AccountId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
POST /rest-api/v1/accounts/{accountId}/uam/policy/generateDescription
