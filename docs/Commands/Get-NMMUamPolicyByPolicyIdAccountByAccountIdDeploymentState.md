...
~~~powershell
Get-NMMUamPolicyByPolicyIdAccountByAccountIdDeploymentState -PolicyId <integer> -AccountId <integer> [-Connection <psobject>]
~~~
...
GET /rest-api/v1/uam/policy/{policyId}/account/{accountId}/deploymentState
