...
~~~powershell
Set-NMMUamRepoPrivateWingetByRepoIdAppsByPackageIdVersionByAppVersionInstallerByInstallerId -RepoId <integer> -PackageId <string> -AppVersion <string> -InstallerId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
PUT /rest-api/v1/uam/repo/private/winget/{repoId}/apps/{packageId}/version/{appVersion}/installer/{installerId}
