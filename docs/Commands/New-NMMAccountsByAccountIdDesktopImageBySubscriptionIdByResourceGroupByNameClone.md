...
~~~powershell
New-NMMAccountsByAccountIdDesktopImageBySubscriptionIdByResourceGroupByNameClone -Name <string> -ResourceGroup <string> -SubscriptionId <string> -AccountId <string> [-InputObject <object>] [-Connection <psobject>]
~~~
...
POST /rest-api/v1/accounts/{accountId}/desktop-image/{subscriptionId}/{resourceGroup}/{name}/clone
