...
~~~powershell
Remove-NMMUamRepoPrivateShellByRepoIdUnlinkstorage -RepoId <integer> [-InputObject <object>] [-Connection <psobject>]
~~~
...
DELETE /rest-api/v1/uam/repo/private/shell/{repoId}/unlinkstorage
